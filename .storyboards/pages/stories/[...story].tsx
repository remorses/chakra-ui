      ...
      >
        {Object.keys(exported)
          ...
          .map((k, i) => {
            ...
            return (
              <StoryBlock title={k} blockWidth="100%" key={k + String(i)}>
                <Stack
                  flex="1"
                  w="100%"
                  h="100%"
      ...
      >
        ...
        {process.env.NODE_ENV !== "production" && (
          <Couple
            ...
            b={
              <AutoUpdateBox fontWeight="500" contentRef={actualDurationRef} />
            }
          />
        )}
        {process.env.NODE_ENV !== "production" && (
      ...
      return (
        ...
        >
          <Stack align="center" spacing="2">
            <Box fontWeight="bold" textAlign="center" display="inline-block">
              Error
            </Box>
            ...
            <Button
              ...
              variant="ghost"
              onClick={() =>
                this.setState((x: any) => ({ ...x, traceOpen: !x.traceOpen }))
              }
            >
              see trace
            </Button>
